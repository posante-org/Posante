...
#include "qt/posante/forms/ui_navmenuwidget.h"
#include "qt/posante/posantegui.h"
#include "qt/posante/qtutils.h"
#include <QScrollBar>

NavMenuWidget::NavMenuWidget(PosanteGUI* mainWindow, QWidget* parent) : PWidget(mainWindow, parent),
...
{
    forceUpdateStyle({ui->btnDashboard,
        ui->btnSend,
        ui->btnAddress,
        ui->btnMaster,
        ui->btnSettings,
