...
#ifndef Posante_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Posante_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Posante_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
