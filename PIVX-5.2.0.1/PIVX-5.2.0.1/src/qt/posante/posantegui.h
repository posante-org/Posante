...
#ifndef Posante_CORE_NEW_GUI_PosanteGUI_H
#define Posante_CORE_NEW_GUI_PosanteGUI_H
...
#include "qt/posante/navmenuwidget.h"
#include "qt/posante/receivewidget.h"
#include "qt/posante/send.h"
#include "qt/posante/settings/settingsfaqwidget.h"
#include "qt/posante/settings/settingswidget.h"
...
/**
  Posante GUI main class. This class represents the main window of the Posante UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PosanteGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PosanteGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~PosanteGUI();
...
#endif //Posante_CORE_NEW_GUI_PosanteGUI_H
