...
#include "qt/posante/forms/ui_sendmultirow.h"
...
#include "qt/posante/sendmemodialog.h"

SendMultiRow::SendMultiRow(PosanteGUI* _window, PWidget* parent) : PWidget(_window, parent),
