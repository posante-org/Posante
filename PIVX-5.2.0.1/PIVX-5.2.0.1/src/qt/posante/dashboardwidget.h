...
#include "config/posante-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalPosa = 0;
    qint64 totalZposa = 0;
    QList<qreal> valuesPosa;
    QList<qreal> valueszPosa;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(PosanteGUI* _window);
    ~DashboardWidget();
