...
#include "qt/posante/topbar.h"
#include "askpassphrasedialog.h"
#include "qt/posante/forms/ui_topbar.h"
#include "qt/posante/loadingdialog.h"
#include "qt/posante/lockunlock.h"
#include "qt/posante/qtutils.h"
#include "qt/posante/receivedialog.h"
...
#include "qt/posante/balancebubble.h"
...
TopBar::TopBar(PosanteGUI* _mainWindow, QWidget* parent) : PWidget(_mainWindow, parent),
                                                           ui(new Ui::TopBar)
{
    ui->setupUi(this);
    ...
    setCssProperty({ui->labelAmountTopPosa, ui->labelAmountTopShieldedPosa}, "amount-small-topbar");
    setCssProperty({ui->labelAmountPosa}, "amount-topbar");
    setCssProperty({ui->labelPendingPosa, ui->labelImmaturePosa}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Posante")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // POSA Total
    QString totalPosa = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // POSA
    // Top
    ui->labelAmountTopPosa->setText(totalTransparent);
    ui->labelAmountTopShieldedPosa->setText(totalShielded);
    // Expanded
    ui->labelAmountPosa->setText(totalPosa);
    ui->labelPendingPosa->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmaturePosa->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
