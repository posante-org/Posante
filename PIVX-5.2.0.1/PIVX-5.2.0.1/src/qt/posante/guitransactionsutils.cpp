...
{
QString ProcessSendCoinsReturn(PWidget::Translator* parent, const WalletModel::SendCoinsReturn& sendCoinsReturn, WalletModel* walletModel, CClientUIInterface::MessageBoxFlags& informType, const QString& msgArg, bool fPrepare)
{
    QString retStr;
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        retStr = parent->translate(
                           "The total amount to pay exceeds the available balance when the %1 transaction fee is included.")
                     .arg(msgArg);
        break;
