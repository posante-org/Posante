...
#include "qt/posante/contactdropdownrow.h"
#include "qt/posante/forms/ui_contactdropdownrow.h"

ContactDropdownRow::ContactDropdownRow(QWidget* parent) : QWidget(parent),
