...
#include "qt/posante/coldstakingwidget.h"
#include "amount.h"
...
#include "qt/posante/csrow.h"
#include "qt/posante/forms/ui_coldstakingwidget.h"
#include "qt/posante/furlistrow.h"
#include "qt/posante/guitransactionsutils.h"
#include "qt/posante/qtutils.h"
#include "qt/posante/requestdialog.h"
#include "qt/posante/sendconfirmdialog.h"
#include "qt/posante/tooltipmenu.h"
...
ColdStakingWidget::ColdStakingWidget(PosanteGUI* parent) : PWidget(parent),
                                                           ...
                                                           isLoading(false)
{
    ...
    // List
    setCssProperty(ui->listView, "bg-trans");
    ...
    // List Addresses
    setCssProperty(ui->listViewStakingAddress, "bg-trans");
...
{
    const bool isValid = ui->lineEditOwnerAddress->text().isEmpty() || (walletModel && walletModel->validateAddress(ui->lineEditOwnerAddress->text()));
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg((total == 0) ? "0.00 " + QString(CURRENCY_UNIT.c_str()) : GUIUtil::formatBalance(total, nDisplayUnit)));
}
