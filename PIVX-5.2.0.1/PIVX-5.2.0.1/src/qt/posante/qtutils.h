...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, PosanteGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, PosanteGUI* gui, double posX = 3);
