...
#include "qt/posante/coldstakingmodel.h"
#include "qt/posante/contactsdropdown.h"
#include "qt/posante/furabstractlistitemdelegate.h"
#include "qt/posante/pwidget.h"
#include "qt/posante/sendmultirow.h"
#include "qt/posante/tooltipmenu.h"
#include "qt/posante/txviewholder.h"
...
public:
    explicit ColdStakingWidget(PosanteGUI* parent);
    ~ColdStakingWidget();
