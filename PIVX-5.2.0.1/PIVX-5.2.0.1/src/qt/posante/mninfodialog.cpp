...
#include "guiutil.h"
#include "qt/posante/forms/ui_mninfodialog.h"
#include "qt/posante/qtutils.h"
#include "wallet/wallet.h"
#include "walletmodel.h"
#include <QDateTime>

MnInfoDialog::MnInfoDialog(QWidget* parent) : FocusedDialog(parent),
                                              ui(new Ui::MnInfoDialog)
{
    ...
    connect(ui->pushCopy, &QPushButton::clicked, [this]() { copyInform(pubKey, tr("Communitynode public key copied")); });
