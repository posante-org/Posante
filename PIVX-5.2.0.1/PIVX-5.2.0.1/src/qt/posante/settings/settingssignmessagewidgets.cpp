...
#include "qt/posante/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
