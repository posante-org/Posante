...
#include "qt/posante/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
