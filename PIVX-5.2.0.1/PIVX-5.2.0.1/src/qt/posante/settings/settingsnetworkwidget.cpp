...
#include "qt/posante/settings/settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/posante/qtutils.h"
#include "qt/posante/settings/forms/ui_settingsnetworkwidget.h"

SettingsNetworkWidget::SettingsNetworkWidget(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
