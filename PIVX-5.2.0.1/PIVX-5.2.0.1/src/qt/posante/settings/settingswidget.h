...
#include "qt/posante/settings/settingsbackupwallet.h"
#include "qt/posante/settings/settingsbittoolwidget.h"
#include "qt/posante/settings/settingsconsolewidget.h"
#include "qt/posante/settings/settingsdisplayoptionswidget.h"
#include "qt/posante/settings/settingsexportcsv.h"
#include "qt/posante/settings/settingsinformationwidget.h"
#include "qt/posante/settings/settingsmainoptionswidget.h"
#include "qt/posante/settings/settingsmultisendwidget.h"
#include "qt/posante/settings/settingssignmessagewidgets.h"
#include "qt/posante/settings/settingswalletoptionswidget.h"
#include "qt/posante/settings/settingswalletrepairwidget.h"
#include <QWidget>
...
public:
    explicit SettingsWidget(PosanteGUI* parent);
    ~SettingsWidget();
