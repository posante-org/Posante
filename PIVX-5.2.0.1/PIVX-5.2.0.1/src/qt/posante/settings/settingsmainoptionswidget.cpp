...
#include "QListView"
#include "qt/posante/settings/forms/ui_settingsmainoptionswidget.h"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
                                                                                             ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start Posante on system login"));
