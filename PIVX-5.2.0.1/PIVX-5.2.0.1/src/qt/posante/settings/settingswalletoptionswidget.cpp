...
#include "qt/posante/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
