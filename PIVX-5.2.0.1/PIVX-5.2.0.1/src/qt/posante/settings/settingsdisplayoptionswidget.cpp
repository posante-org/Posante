...
#include "qt/posante/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QDir>
#include <QListView>
#include <QSettings>

SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
