...
#include "qt/posante/settings/forms/ui_settingswalletrepairwidget.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
                                                                                               ui(new Ui::SettingsWalletRepairWidget)
{
    ...
    // Containers
    ui->left->setProperty("cssClass", "bg-trans");
    ui->left->setContentsMargins(10, 10, 10, 10);
    ui->scrollStack->setProperty("cssClass", "bg-trans");
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PosanteGUI::handleRestart()
