...
#include "qt/posante/settings/forms/ui_settingsbackupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
