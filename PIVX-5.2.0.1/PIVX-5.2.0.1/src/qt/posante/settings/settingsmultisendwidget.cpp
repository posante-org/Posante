...
#include "qt/posante/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/posante/settings/settingsmultisenddialog.h"
                                                                    ...
                                                                    ui(new Ui::SettingsMultisendWidget)
{
    ...
    // Containers
    setCssProperty(ui->left, "bg-trans");
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or communitynode reward to a list of other Posante addresses after it matures."));
    ...
    ui->checkBoxRewards->setText(tr("Send communitynode rewards"));
...
void SettingsMultisendWidget::activate()
{
    ...
    if (pwalletMain->vMultiSend.size() < 1)
        ...
        strRet = tr("Unable to activate MultiSend\nCheck one or both of the check boxes to send on stake and/or communitynode rewards");
