...
#include "qt/posante/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(PosanteGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("Posante_tx_csv_export(*.csv)") : tr("Posante_addresses_csv_export(*.csv)"),
        nullptr);
