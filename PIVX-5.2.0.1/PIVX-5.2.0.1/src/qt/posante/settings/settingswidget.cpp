...
#include "qt/posante/settings/forms/ui_settingswidget.h"
#include "utilitydialog.h"
#include "wallet/wallet.h"
#include <QDataWidgetMapper>
#include <QScrollBar>

SettingsWidget::SettingsWidget(PosanteGUI* parent) : PWidget(parent),
                                                     ui(new Ui::SettingsWidget)
{
    ...
    /* Containers */
    setCssProperty(ui->scrollArea, "bg-trans");
