...
#include "qt/posante/forms/ui_sendchangeaddressdialog.h"
#include "qt/posante/qtutils.h"

SendChangeAddressDialog::SendChangeAddressDialog(QWidget* parent, WalletModel* model) : FocusedDialog(parent),
                                                                                        walletModel(model),
