...
#include "qt/posante/addressholder.h"
#include "qt/posante/forms/ui_receivewidget.h"
...
ReceiveWidget::ReceiveWidget(PosanteGUI* parent) : PWidget(parent),
                                                   ui(new Ui::ReceiveWidget)
{
    ...
    // List Addresses
    setCssProperty(ui->listViewAddress, "bg-trans");
