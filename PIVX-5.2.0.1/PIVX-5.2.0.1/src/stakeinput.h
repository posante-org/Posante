...
#ifndef Posante_STAKEINPUT_H
#define Posante_STAKEINPUT_H
...
class CPosaStake : public CStakeInput
{
private:
...
public:
    CPosaStake(const CTxOut& _from, const COutPoint& _outPointFrom, const CBlockIndex* _pindexFrom) : CStakeInput(_pindexFrom), outputFrom(_from), outpointFrom(_outPointFrom) {}

    static CPosaStake* NewPosaStake(const CTxIn& txin);
