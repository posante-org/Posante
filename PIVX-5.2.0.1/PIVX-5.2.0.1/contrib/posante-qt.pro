...
RESOURCES += src/qt/posante.qrc src/qt/posante_locale.qrc

TRANSLATIONS += src/qt/locale/posante_bg.ts \
                src/qt/locale/posante_de.ts \
                src/qt/locale/posante_en.ts \
                src/qt/locale/posante_es.ts \
                src/qt/locale/posante_fi.ts \
                src/qt/locale/posante_fr.ts \
                src/qt/locale/posante_it.ts \
                src/qt/locale/posante_ja.ts \
                src/qt/locale/posante_pl.ts \
                src/qt/locale/posante_pt.ts \
                src/qt/locale/posante_ru.ts \
                src/qt/locale/posante_sk.ts \
                src/qt/locale/posante_sv.ts \
                src/qt/locale/posante_vi.ts \
                src/qt/locale/posante_zh_CN.ts \
                src/qt/locale/posante_zh_TW.ts
