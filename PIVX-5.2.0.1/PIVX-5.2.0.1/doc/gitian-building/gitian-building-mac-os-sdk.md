...
The script [extract-osx-sdk.sh](https://github.com/posante-project/posante/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
posante/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/posante-project/posante/blob/master/doc/README_osx.md) for troubleshooting tips.