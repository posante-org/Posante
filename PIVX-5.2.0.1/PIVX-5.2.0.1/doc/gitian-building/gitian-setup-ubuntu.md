...
The build script we'll be using is contained in the Posante github repository ([contrib/gitian-build.py](https://github.com/posante-project/posante/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Posante repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Posante-Project/Posante/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, posante-detached-sigs, and posante GitHub repos.
