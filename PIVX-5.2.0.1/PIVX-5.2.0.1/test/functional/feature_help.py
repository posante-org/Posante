...
"""Verify that starting posante with -h works as expected."""
import subprocess

from test_framework.test_framework import PosanteTestFramework
from test_framework.util import assert_equal

class HelpTest(PosanteTestFramework):
    ...
    def run_test(self):
        self.log.info("Start posante with -? for help text")
        ...
        self.log.info("Start posante with -version for version information")
