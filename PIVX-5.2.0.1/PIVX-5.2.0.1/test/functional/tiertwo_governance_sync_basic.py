...
from test_framework.test_framework import PosanteTier2TestFramework
...
class MasternodeGovernanceBasicTest(PosanteTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.posante.org/t/test-proposal"
