...
class ListReceivedTest (PosanteTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 POSA.
        ...
        # Send 1 POSA to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 POSA sending them all (fee is 0.1 POSA)
        ...
        # Confirm transaction (2 POSA from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 POSA, send 0.6 POSA + 0.05 POSA fee
