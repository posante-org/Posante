Contributing to Posante Core
============================

The Posante Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/posante-project/posante/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Posante Core project, and is not to be
confused with overall Posante Network Protocol consensus changes.

Whether a pull request is merged into Posante Core rests with the project merge
...
Patches that change Posante consensus rules are considerably more involved than
...
Where a patchset proposes to change the Posante consensus, it must have been
...
The project leader is the release manager for each Posante Core release.
